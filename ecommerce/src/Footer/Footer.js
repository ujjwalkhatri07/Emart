        ...
        return(
          ...
          <footer className="page-footer font-small blue-grey lighten-5">
            ...
            <div className="container text-center text-md-left mt-5">
              ...
              <div className="row mt-3 dark-grey-text">
                ...
                <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  ...
                  <hr className="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style= {{width: '60px'}}></hr>
                  <p>
                    <i className="fas fa-home mr-3"></i>  KTM 10012, Baluwatar</p>
                  <p>
                    <i className="fas fa-envelope mr-3"></i>Emart@gmail.com</p>
                  <p>
            ...
            <div className="footer-copyright text-center text-black-50 py-3">© 2020 Copyright:
              <a className="dark-grey-text" href="https://mobilenepals.com/"> Emart.com</a>
            </div>
